        ...
        ZStack {
            VStack(spacing:10) {
                ...
                VStack {
                    ...
                    Picker("Rols",selection: $selectedRole) {
            ...
            .alert(isPresented: $registerVM.isSignUpSuccesFull) {
                Alert(title: Text("Sign Up Succesfully"), message:Text("Log in to Continue"), primaryButton: .default(Text("Ok"), action: {
